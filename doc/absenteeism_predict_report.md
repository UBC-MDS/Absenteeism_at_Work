...
the target. Therefore, we removed some extreme outliers. To decide with
observations to discard, the removed the instances where the target was
greater than its mean plus three times its standard deviation. Getting
rid of these extreme instances is required, otherwise, the model will
always be underpredicting. Fortunately, these cases represent only 15 of
the 737 instances, therefore only a small amount of information is being
ignored.
...
| :----------------------------------------- | ----------: | ----------: | ------------: |
| fit\_time                                  |   0.0388702 |   0.0333610 |     0.4129766 |
| score\_time                                |   0.0115796 |   0.0082788 |     0.0166212 |
...
| index                                      |  Linear SVM |       Ridge | Random Forest |
| :----------------------------------------- | ----------: | ----------: | ------------: |
| fit\_time                                  |   1.2331746 |   1.2779443 |     1.4134849 |
| score\_time                                |   0.0094932 |   0.0109894 |     0.0154401 |
...
| :--------------------------------------------------------------------------------------- | ---------------------: |
| Reason for absence\_Neoplasms                                                            |             10.0000000 |
| Reason for absence\_Unknown                                                              |              7.9007345 |
| Reason for absence\_Endocrine, nutritional and metabolic diseases                        |              6.8000000 |
| Reason for absence\_Physiotherapy                                                        |              5.8008534 |
| Reason for absence\_Dental consultation                                                  |              5.8006141 |
| Reason for absence\_Medical consultation                                                 |              5.8000000 |
| Reason for absence\_Certain conditions originating in the perinatal period               |              5.8000000 |
| Reason for absence\_Laboratory examination                                               |              4.8000000 |
| Reason for absence\_Certain infectious and parasitic diseases                            |              0.1991466 |
| Reason for absence\_Diseases of the eye and adnexa                                       |              0.1013705 |
| Reason for absence\_Diseases of the digestive system                                     |              0.1013671 |
| Reason for absence\_Diseases of the genitourinary system                                 |              0.1007734 |
| Social drinker                                                                           |              0.1004548 |
| Day of the week\_Tuesday                                                                 |              0.1001593 |
| Reason for absence\_Injury, poisoning and certain other consequences of external causes  |              0.0000000 |
...
| Reason for absence\_Congenital malformations, deformations and chromosomal abnormalities |              0.0000000 |
